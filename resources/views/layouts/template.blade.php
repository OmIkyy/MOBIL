      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            <h4>Hubungi Kami</h4>
            <p>
              Jln.Palembang Sekayu <br>
              Simpang Gardu, Ptpn 7<br>
              Sumatra Selatan <br><br>
              <strong>Phone:</strong>+6285709773585<br>
              <strong>Email:</strong>Metrorentalmobil12@gmail.com<br>
            </p>
